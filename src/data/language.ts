...
export const vocabulary: VocabWord[] = [
  ...
  { koshur: "nechuv", english: "son", lang: "en" },
  {
    ...
    lang: "en",
    isLoanword: true,
    note: "Persian loanword; native word is 'pōny'.",
  },
  ...
  { koshur: "kitab", english: "book", lang: "en", isLoanword: true, note: "Arabic loanword." },
  {
    ...
    english: "school",
    lang: "en",
    note: "'Madrasa' usually means a religious school.",
  },
  ...
  { koshur: "khosh", english: "happy", lang: "en", isLoanword: true, note: "Persian loanword." },
  {
    ...
    english: "cold",
    lang: "en",
    note: "Native Kashmiri; 'sheen' means snow, 'shohul' means cool.",
  },
  {
    koshur: "garam",
    english: "warm",
...
export const phrases: Phrase[] = [
  {
    koshur: "Assalamu alaikum",
    english: "Peace be upon you (greeting)",
    lang: "en",
    isLoanword: true,
    note: "Arabic; common Muslim greeting.",
  },
  {
    koshur: "Vaaray chivā?",
    english: "How are you?",
    lang: "en",
    note: "The native Kashmiri greeting.",
  },
  { koshur: "Bi chhus vaaray", english: "I am fine", lang: "en" },
  {
    koshur: "Meharbāni",
    english: "Please / thank you (literally: your kindness)",
    lang: "en",
    note: "The native way to say thanks. 'Shukriya' from Urdu is also widely used.",
  },
  {
    koshur: "Tohi kya chhu nāv?",
    english: "What is your name?",
    lang: "en",
    note: "Kashmiri usually puts the verb second.",
  },
