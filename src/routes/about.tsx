      ...
      <section className="mx-auto max-w-3xl px-4 py-8 space-y-6">
        <article className="rounded-xl border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            Content is written in simple English so it is easy for young
            readers and for people learning English. Drafts are created with
            the help of AI and then reviewed by a human before publishing. Our
            language content is being checked by native Kashmiri speakers.
          </p>
        </article>
        ...
        <article className="rounded-xl border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            We try to cite at least two sources for any factual or historical
            content. Our history section covers ancient times up to 1947 only.
            Civic information on this site is general education, not legal
            advice.
          </p>
        </article>
        ...
        <article className="rounded-xl border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            We want to get things right. If you spot a mistake or would like
            to suggest an addition, please email us at{" "}
            <a
