    ...
    <SiteLayout>
      <section className="mx-auto max-w-3xl px-4 pt-12 pb-6">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed">
          Kashmiri.dev is a free educational website about Kashmir, including its history, language,
          people, and practical learning. It is made for Kashmiri readers, especially in the valley.
          The site focuses on learning rather than daily news or political commentary, and it does
