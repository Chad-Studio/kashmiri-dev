    ...
    <SiteLayout>
      <section className="mx-auto max-w-3xl px-4 pt-12 pb-6">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed">
          AI tools can be a patient tutor, a coding helper, and a writing coach. Below are simple
          prompts you can copy, a short list of good free tools, and tips to protect yourself from
          fake AI content.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-4 py-10">
        ...
        <p className="mt-3 text-xs text-muted-foreground">
          Most tools have a free plan. Always read a tool's own privacy notice before you share
