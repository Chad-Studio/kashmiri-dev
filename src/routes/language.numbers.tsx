  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kashmiri Counting 1 to 50 — Kashmiri.dev" },
      {
        ...
        content:
          "Kashmiri (Koshur) numbers 1 to 50 with easy Roman spellings for beginners.",
      },
      { property: "og:url", content: "https://kashmiri.dev/language/numbers" },
    ],
    links: [
      { rel: "canonical", href: "https://kashmiri.dev/language/numbers" },
    ],
    scripts: [
      {
    ...
    <SiteLayout>
      <section className="mx-auto max-w-3xl px-4 pt-12 pb-6">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed">
          A simple list of Kashmiri (<em>Koshur</em>) numbers from one to
          fifty, written in Roman letters so beginners can read them easily.
          Numbers are grouped by tens to make them easier to remember.
        </p>
        <div className="mt-4 rounded-lg border border-primary/30 bg-primary/5 p-4 text-sm text-foreground/85 leading-relaxed">
          Kashmiri has no fully standard Roman spelling. Spellings can vary
          between books and regions. Native script (Perso-Arabic) and audio
          are coming soon. These forms are being reviewed by native speakers.
        </div>
      </section>
              ...
              <ul className="divide-y divide-border">
                {numbers
                  ...
                  .map((n) => (
                    ...
                    >
                      <span className="font-mono text-sm text-primary w-8 shrink-0">
                        {n.digit}
                      </span>
                      <span
                        lang="ks"
                        className="font-serif text-lg text-foreground flex-1"
                      >
                        {n.koshur}
                      </span>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-8">
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Once you know the tens — <em lang="ks">dah</em> (10),{" "}
            <em lang="ks">wuh</em> (20), <em lang="ks">trih</em> (30),{" "}
            <em lang="ks">tsatji</em> (40), <em lang="ks">pantsah</em> (50) —
            the numbers in between become easier. Many follow patterns built
            from the ones and the tens.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-16">
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
            <li>
              Braj B. Kachru, <em>An Introduction to Spoken Kashmiri</em>{" "}
