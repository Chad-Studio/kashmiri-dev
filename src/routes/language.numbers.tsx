    ...
    <SiteLayout>
      <section className="mx-auto max-w-3xl px-4 pt-12 pb-6">
        ...
        <div className="mt-4 rounded-lg border border-primary/30 bg-primary/5 p-4 text-sm text-foreground/85 leading-relaxed">
          Kashmiri has no fully standard Roman spelling. Spellings can vary between books and
          regions. Native script (Perso-Arabic) and audio are coming soon. These forms are being
...
/** Spells out a whole number below 100 in English; falls back to digits outside that range. */
